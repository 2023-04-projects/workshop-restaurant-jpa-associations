...
<body>
    <h1>Order Lunch </h1>
    <form action="curd_rice" method="post">
        <table>
            <tr>
                <td>Lunch Name:</td>
                <td><input type="text" name="lunchName" value="Curd_rice" readonly></td>
            </tr>
            <tr>
                <td>Quantity:</td>
            ...
            <tr>
                <td>Price (per one):</td>
                <td><input type="text" id="price" name="price" value="40" readonly></td>
            </tr>
            <tr>
                <td>Total Price:</td>
