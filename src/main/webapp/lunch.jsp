...
<body>
	...
	<form action="addcart.jsp" method="post">
		<table>
			<tr>
				<td>Lunch Name:</td>
				<td><input type="text" name="lunchName"
					value="<%=request.getParameter("lunchname")%>" readonly></td>
			</tr>
			<tr>
				<td>Quantity:</td>
			...
			<tr>
				...
				<td><input type="text" id="price" name="price" value="<%=request.getParameter("lunchprice")%>"
					readonly></td>
			</tr>
			<tr>
				<td>Total Price:</td>
		...
		<input type="hidden" name="menuname" value="Lunch">
	</form>
</body>
</html>