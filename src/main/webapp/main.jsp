		...
		<tr>
			...
			<th>
				<div class="dropdown">
					...
					<div class="dropdown-content">
						<a href="Meals.jsp" target="content-frame">Meals</a> <a
							href="Fried_rice.jsp" target="content-frame">Fried_rice</a> <a
							href="Curd_rice.jsp" target="content-frame">Curd_rice</a> <a
							href="Biryani.jsp" target="content-frame">Biryani</a>
					</div>
				</div>
			</th>
			<th>
